...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (requestAlreadySent)
      throw new ConvexError("Friend request already sent to this user");
    ...
    if (requestAlreadyReceived)
      throw new ConvexError("user already sent you a friend request.");
    ...
    if (
      ...
      throw new ConvexError("You're already friend with this user");
    }
